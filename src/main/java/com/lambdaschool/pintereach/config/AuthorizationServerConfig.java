        ...
        extends AuthorizationServerConfigurerAdapter
{
     ...
     */
    static final String CLIENT_ID = System.getenv("OAUTHCLIENTID") != null ? System.getenv("OAUTHCLIENTID") : "lambda-client";


    /**
     * Client secret is the password for the client application. It is read from the environment variable OAUTHCLIENTSECRET
     */
    static final String CLIENT_SECRET = System.getenv("OAUTHCLIENTSECRET") != null ? System.getenv("OAUTHCLIENTSECRET") : "lambda-secret"; // read from environment variable
